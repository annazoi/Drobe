import { Box, ButtonGroup, Heading, Text, useDisclosure, VStack, HStack } from '@chakra-ui/react';
			...
			<VStack spacing={12} align="stretch">
				...
				<Box>
					<HStack justify="space-between" mb={8} align="center">
						<Heading size="sm" fontWeight="900" letterSpacing="widest" textTransform="uppercase">
							INVENTORY
						</Heading>
						<HStack spacing={8}>
